...
print(RR_Bitcoin.predict_for_tomorrow())
...
print(Ridge_Bitcoin.predict_for_tomorrow())
...
print(Ridge_cardano.predict_for_tomorrow())
...
print(Ridge_ethereum.predict_for_tomorrow())
...
print(Ridge_dogecoin.predict_for_tomorrow())
